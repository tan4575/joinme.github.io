			...
			<div className="colorlib-narrow-content">
				...
				<div className="row">
					...
					<div className="blog-entry">
						<a href="blog.html" className="blog-img"><img src="images/AuroraFlag_Stalnacke_6677.jpg" className="img-responsive" alt="HTML5 Bootstrap Template by colorlib.com" /></a>
						<div className="desc">
